          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="mt-1 block w-full rounded-lg border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 p-3 transition-all duration-300"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3 px-6 rounded-lg hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 shadow-md font-medium"
                >
                  Send Message
                </button>
              </form>
            ...
            >
              <div className="bg-white rounded-xl shadow-md p-6 border border-slate-100">
                <h2 className="text-2xl font-semibold mb-4 text-slate-800">Our Office</h2>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">+254742079321</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">info@nomadicadventures.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">Weekends: 9:00 AM - 4:00 PM</p>
                    </div>
                  </div>
                </div>
              </div>
              
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-slate-100 h-64">
                <DynamicMap />
              </div>
              
              <div className="bg-white rounded-xl shadow-md p-6 border border-slate-100">
                <h2 className="text-xl font-semibold mb-4 text-slate-800">Connect With Us</h2>
                <div className="flex space-x-4">
                  <a href="#" className="bg-slate-100 hover:bg-slate-200 p-3 rounded-full transition-colors duration-300">
